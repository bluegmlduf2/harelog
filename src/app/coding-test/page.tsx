...
export default function CodingTestPage() {
    ...
    const submitAnswer = () => {
        ...
        const selectedOptionData = currentQuiz?.options.find(opt => opt.id === selectedOption);
            ...
            <main className="max-w-4xl mx-auto px-4 py-8">
                            ...
                            {error && (
                                <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded-lg">
                                    <div className="flex items-center">
                                        ...
                                        <div>
                                            <p className="font-medium">퀴즈 생성 실패</p>
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-3 gap-3">
                                    {([
                                        ...
                                        { value: 'ja', label: '🇯🇵 日本語' }
                                    ] as { value: UserLanguage; label: string }[]).map((lang) => (
                                        <button
                                            key={lang.value}
                                ...
                                {currentQuiz.options.map((option) => (
                                    ...
                                    >
                                        <div className="flex items-center">
                                            ...
                                            {showResult && option.isCorrect && selectedOption !== option.id && (
                ...
                <div className="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div className="space-y-2 text-gray-700">
                        <p>• AI가 생성한 코드와 4개의 설명 중 틀린 설명을 찾는 게임입니다</p>
